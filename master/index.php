                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="blog.html">Flagship</a>
                                            <ul class="submenu">
                                                <li><a href="blog.html">Workshop 1</a></li>
                                                <li><a href="blog_details.html">Workshop 2</a></li>
                                                <li><a href="elements.html">Workshop 3</a></li>
                                                <li><a href="blog.html">Workshop 4</a></li>
                                                <li><a href="blog_details.html">Workshop 5</a></li>
                                                <li><a href="elements.html">Workshop 6</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="blog.html">Registrations</a>
                                            <ul class="submenu">
                                                <li><a href="blog.html">CSE</a>
                                                    <ul class="submenu sub">
                                                        <li><a href="blog_details.html">CHEM</a></li>
                                                        <li><a href="elements.html">MECH</a></li>
                                                        <li><a href="blog.html">IT</a></li>
                                                    </ul>
                                                </li>
                                                <li><a href="blog_details.html">ECE</a></li>
                                                <li><a href="elements.html">CIVIL</a></li>
                                                <li><a href="blog.html">EEE</a></li>
                                                <li><a href="blog_details.html">CHEM</a></li>
                                                <li><a href="elements.html">MECH</a></li>
                                                <li><a href="blog.html">IT</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="blog.html">Spot</a>
                                            <ul class="submenu">
                                                <li><a href="blog.html">Event 1</a></li>
                                                <li><a href="blog_details.html">Event 2</a></li>
                                                <li><a href="elements.html">Event 3</a></li>
                                                <li><a href="blog.html">Event 4</a></li>
                                                <li><a href="blog_details.html">Event 5</a></li>
                                                <li><a href="elements.html">Event 6</a></li>
                                            </ul>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-8 col-md-9 col-sm-10">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay=".5s">GMRIT PRESENTS STEPCONE 2023</h1>
                                <span data-animation="fadeInLeft" data-delay=".1s">15th Edition</span>
                                <!-- Hero-btn -->
                                <div class="slider-btns">
                                    <a data-animation="fadeInLeft" data-delay="1.0s" href="" class="btn">LOGIN</a>
                                </div>
                                <div class="slider-btns">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <a href="about.html" class="btn mt-50">Explore More</a>
                </div>
                <div class="col-lg-6 col-md-12">
                    <!-- about-img -->
                    <div class="about-img ">
                    ...
                    <div class="properties__button mb-40">
                        ...
                        <nav>                                                                         
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Day - 01  Tuesday, Jan 24 2023</a>
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"> Day - 02 wednesday, 25 2023</a>
                            </div>
                        </nav>
                        <!--End Nav Button  -->
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-logo mb-30">
                                    <img src="assets/img/gallery/byjus_brand.png" alt="">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-logo mb-30">
                             ...
                             <div class="footer-form" >
                                 <div id="mc_embed_signup">
                                     ...
                                     method="get" class="subscribe_form relative mail_part">
                                         <input type="email" name="email" id="newsletter-form-email" placeholder="Message Me..."
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>contact Link</h4>
                                <ul class="row media">
                                    <li><a href="https://www.facebook.com/stepcone2023"><i class="fab fa-facebook-f"></i></a></li>
